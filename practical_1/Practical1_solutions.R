# Practical 1 — Full solutions
# File: practical_1/Practical1_solutions.R
# Purpose: Fully worked solutions for Practical1 (EDA, extreme-value analyses, dependence
# and using the provided Extreme causality functions).
# Notes:
# - This script assumes the data file `River_and_precip_Neuchatel.csv` and
#   the helper `JuroExtremes.R` are in the same folder (`practical_1`).
# - To run a quick verification from the command-line use:
#     Rscript -e "Sys.setenv(RUN_PRACTICAL1_TEST='1'); source('practical_1/Practical1_solutions.R')"
#   That will load the data, run basic checks, and print short summaries.
...
# evd provides fgev and fpot; ismev provides gpd.fit (used as an alternative)
